...
def pvpg(atl03path, atl08path, j=None):
    """
    Version of pvpg function that works using the PhoREAL package.
    
    atl03path - path/to/atl03/file/
    atl08path - path/to/matched-atl08/file/
    j - index of filepath if cycling through array of paths.
    """
    i = 0
